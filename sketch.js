...
var Smario,marioSp,marioJ,tunnel,t1,t2,t3,t4,t5,tunnelSp;
...
function setup(){
    ...
    InvisibleG = createSprite(displayWidth*4,displayHeight-100,displayWidth*20,5);
    InvisibleG.visible = false;

    leftE = createSprite(-505,displayHeight/2,5,displayHeight);
    leftE.visible = false; 

    rightE = createSprite(displayWidth*8-350,displayHeight/2,5,displayHeight);
...
function draw(){
    ...
    v16.bounce(v13);
    v17.bounceOff(t5);
    v17.bounceOff(rightE);
    v18.bounceOff(t5);
    v18.bounceOff(rightE);
    v19.bounceOff(t5);
    v19.bounceOff(rightE);
    v20.bounceOff(t5);
    v20.bounceOff(rightE); 
    v17.bounce(v18);
    v18.bounce(v19);
    v19.bounce(v20);
    v20.bounce(v17);
 ...
 if(gamestate === END1){
    ...
    text("YOU REACHED TO HOSPITAL DUE TO COVID-19",marioSp.x-400,350);
    
}

   if (gamestate === END2){
    homeSp = createSprite(displayWidth*8-500,displayHeight-230);
    homeSp.addImage(home);
    homeSp.scale = 3;
    flagSp = createSprite(displayWidth*8-850,displayHeight-275);
    flagSp.scale = 2 
    flagSp.addImage(flag);
    text("YOU REACHED HOME SAFELY",marioSp.x-400,350);
}

 if(gamestate === END3){
    marioSp.destroy();
    text("YOU DIED DUE TO COVID-19",marioSp.x-1000,350);
    }
...
function end(){
    hospitalSp = createSprite(displayWidth*8-500,displayHeight-250);
